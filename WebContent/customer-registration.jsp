							...
							<div class="row">
								<div class="col-md-6 mb-3">
									<input type="text" name="id"
										value="${requestScope.customer.id}" hidden /> <label
										for="first_name">First Name <span>*</span></label> <input
										type="text" required class="form-control" id="first_name"
										name="firstName" value="${requestScope.customer.firstName}"
										required>
								</div>
								<div class="col-md-6 mb-3">
									<label for="last_name">Last Name </label> <input
										type="text" class="form-control" id="last_name"
										name="lastName" value="${requestScope.customer.lastName}">
								</div>

								<div class="col-md-6 mb-3">
									<label for="phone_number">Phone No <span>*</span></label> <input
										type="number" class="form-control" id="phone_number" min="0"
										value="${requestScope.customer.mobile}" name="mobile" required>
								</div>
								<div class="col-md-6 mb-4">
									<label for="email_address">Email Address <span>*</span></label>
									<input type="email" class="form-control" id="email_address"
										value="${requestScope.customer.email}" name="email" required>
								</div>
								...
								<div class="col-12 mb-3">
									<label for="street_address">Address </label> <input
										...
										value="${requestScope.customer.street1}" name="street1"> <input type="text" class="form-control"
										id="street_address2" value="${requestScope.customer.street2}" name="street2">
								</div>
								<div class="col-md-6 mb-3">
									<label for="city">Town/City <span>*</span></label> <input
										type="text" class="form-control" id="city" value="${requestScope.customer.city}" name="city" required>
								</div>
								<div class="col-md-6 mb-3">
									<label for="state">State/Province </label> <input
										type="text" class="form-control" id="state" value="${requestScope.customer.state}" name="state">
								</div>
								<div class="col-md-6 mb-3">
									<label for="postcode">Post Code </label> <input
										type="text" class="form-control" id="postcode" value="${requestScope.customer.postCode}" name="postCode">
								</div>
								<div class="col-md-6 mb-3">
									<label for="country">Country <span>*</span></label> <select
										class="w-100" id="country" name="country" required>
								...
								<div class="col-12">
									<div class="custom-control custom-checkbox d-block mb-2">
										<input type="checkbox" required class="custom-control-input"
											id="customCheck1" name="tncAccepted" <%-- value="${requestScope.customer.tncAccepted}" --%>> <label
											class="custom-control-label" for="customCheck1">Terms
											and conditions</label>
									</div>
									<c:if test="${requestScope.customer.id ne null}">
										<input type="submit" class="btn etwig-btn btn-block"
											value="Update">
									</c:if>

									<c:if test="${requestScope.customer.id eq null}">
										<input type="submit" class="btn etwig-btn btn-block"
											value="Register">
									</c:if>
