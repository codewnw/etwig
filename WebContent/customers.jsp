	...
	<header class="header_area">
		<div
			...
			<nav class="classy-navbar" id="etwigNav">
				<!-- Logo -->
				<a class="nav-brand" href="${pageContext.request.contextPath}/index.html"><img
			...
			<div class="header-meta d-flex clearfix justify-content-end">
				...
				<!-- Cart Area -->
				<div class="cart-area">
					<a href="#" id="etwigCartBtn"><img src="${pageContext.request.contextPath}/img/core-img/bag.svg"
						alt=""> <span>3</span></a>
				</div>
			</div>
			...
			<div class="cart-list">
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/img/product-img/product-1.jpg" class="cart-thumb" alt="">
						<!-- Cart Item Desc -->
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/img/product-img/product-2.jpg" class="cart-thumb" alt="">
						<!-- Cart Item Desc -->
						<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"></i></span> <span class="badge">Mango</span>
				...
				<div class="single-cart-item">
					<a href="#" class="product-image"> <img
						src="${pageContext.request.contextPath}/img/product-img/product-3.jpg" class="cart-thumb" alt="">
						<!-- Cart Item Desc -->
						<div class="cart-item-desc">
							<span class="product-remove"><i class="fa fa-close"
								aria-hidden="true"></i></span> <span class="badge">Mango</span>
						...
						<tbody>
							<c:forEach var="customer" items="${requestScope.customers}">
								<tr>
									...
									<td><a href="${pageContext.request.contextPath}/customers/update/${customer.id}" class="btn btn-primary">Update</a>/
									<a href="${pageContext.request.contextPath}/customers/delete/${customer.id}" class="btn btn-danger">Delete</a></td>
								</tr>
							</c:forEach>
							<tr>
							<td colspan="4"><a href="${pageContext.request.contextPath}/customer-registration.html" class="btn btn-info btn-lg btn-block">Add Customer</a></td>
							</tr>
						</tbody>
					</table>
				</div>
